/*
 Leaflet.draw 1.0.5-alpha.9, a plugin that adds drawing and editing tools to Leaflet powered maps.
...
L.Draw.SimpleShape = L.Draw.Feature.extend({
	...
	_onMouseMove: function (e) {
		...
		if (this._isDrawing) {
			...
			this._map.fire(L.Draw.Event.DRAWING, {layer: this._shape, tooltip: this._tooltip})
		}
	},
