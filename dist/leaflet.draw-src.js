/*
 Leaflet.draw 1.0.5-alpha.4, a plugin that adds drawing and editing tools to Leaflet powered maps.
...
L.Draw.SimpleShape = L.Draw.Feature.extend({
	...
	_onMouseMove: function (e) {
		...
		if (this._isDrawing) {
			...
			if (options) {
				L.setOptions(this, options);
				this._tooltip.updateContent({text: "salam" + JSON.stringify(options)});
			} else {
